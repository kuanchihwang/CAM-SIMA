...
contains
    ...
    subroutine dyn_mpas_run(self)
        ...
        type(mpas_pool_type), pointer :: mpas_pool_diag => null()
        type(mpas_pool_type), pointer :: mpas_pool_mesh => null()
        type(mpas_pool_type), pointer :: mpas_pool_state => null()
        type(mpas_time_type) :: mpas_time_end ! This derived type is analogous to `ESMF_Time`.
        type(mpas_time_type) :: mpas_time_now ! This derived type is analogous to `ESMF_Time`.
        ...
        nullify(config_dt)
        nullify(mpas_pool_diag)
        nullify(mpas_pool_mesh)
        nullify(mpas_pool_state)
